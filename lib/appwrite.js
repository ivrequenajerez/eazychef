...
export const config = {
  ...
  platform: "com.eazy.eazychefe",
  projectId: "66616652000560dfc448",
  databaseId: "66616807002f729f2535",
  // Colecciones -> Tablas
  userCollectionId: "666168350025d4a3f7af",
  videoCollectionId: "66616866001406d0ad1c",
  ingredientesCollectionId: "666169a9001910959cc1",
  // FIN Colecciones
  storageId: "66616ac900113b718773",
  teamId: "66616ae10006b299d233",
};
...
export const deleteIngredient = async (ingredientId) => {
  try {
    ...
    Alert.alert("No tienes permiso para realizar esta acción")
  }
};
